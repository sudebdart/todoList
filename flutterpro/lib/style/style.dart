...
const colorLoader = Color(0x53D3C3C);
...
Container StatusChild(statusText, statusColor) {
  return Container(
      ...
      child: Text(statusText, style: TextStyle(
          color: colorWhite,
          fontSize: 10,
          fontWeight: FontWeight.w400)), decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),
        color: statusColor,
      ),
      // BoxDecoration
      height: 25,
...
ButtonStyle AppStatusButtonStyle(colorBtn){
  return ElevatedButton.styleFrom(
    elevation: 1,
    padding: EdgeInsets.zero, backgroundColor: colorBtn,
  ) ;
}